...
public class ECGData implements JsonLizable, Parcelable {
    ...
    private int second;
    private int signal;
    private List<Integer> waveformList;
    private int year;
    ...
    public void unPack(byte[] bArr) {
        ...
        this.waveformList = new ArrayList(length);
        for (int i = 0; i < length; i++) {
            int i2 = i * 2;
            int i3 = i2 + 34;
            if (i3 < bArr.length) {
                this.waveformList.add(Integer.valueOf((bArr[i2 + 35] & 255) | ((bArr[i3] << 8) & 65280)));
            }
        }
    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            if (this.waveformList != null && this.waveformList.size() > 0) {
                for (int i = 0; i < this.waveformList.size(); i++) {
                    jSONArray.put(this.waveformList.get(i));
                }
            }
    ...
    public List<Integer> getWaveformList() {
        return this.waveformList;
    }

    public void setWaveformList(List<Integer> list) {
